const GitIcon = ({ className = "w-6 h-6 text-gray-800 dark:text-white" }) => {
  return (
    <svg
      className={className}
      aria-hidden="true"
...
const LinkIcon = ({ className = "w-6 h-6 text-gray-800 dark:text-white" }) => {
  return (
    <svg
      className={className}
      aria-hidden="true"
...
export { GitIcon, LinkIcon, NotionIcon, BurgerIcon };
