...
const timelineData = [
  {
    date: "2023/02",
    description: "Try kotlin for App, Too hard for novice.",
  },
  {
    date: "2023/04",
    description: "Initial exposure to with html, css and javascript.",
  },
  {
    date: "2023/07",
    description: "Learning the React.js front-end framework.",
  },
  {
    date: "2023/08",
    description:
      "Serving at Current Company and handling ERP frontend interfaces.",
  },
  {
    date: "2024/01",
    description:
      "Explored learning Corona programming language out of personal interest.",
  },
  {
    date: "2024/03",
    description: "Learning C# for websocket and backend service",
  },
];
